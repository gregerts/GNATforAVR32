...
--  This is a Ravenscar bare board version of this package for AVR32 targets
...
package System is
   ...
   --  252 - 255  correspond to hardware interrupt levels 0 to 3
   --  255        is the priority value that block all interrupts
   --  250        is the maximum value of priority that is not high enough to
   --             require the blocking of one or more interrupts.

   Max_Priority           : constant Positive := 250;
   Max_Interrupt_Priority : constant Positive := 255;

   subtype Any_Priority       is Integer      range   0 .. 255;
   subtype Priority           is Any_Priority range   0 .. 251;
   subtype Interrupt_Priority is Any_Priority range 252 .. 255;

   Default_Priority : constant Priority := 125;
...
private
   ...
   Run_Time_Name : constant String
     := "AVR32 Ravenscar Bare-Board Run-Time";
